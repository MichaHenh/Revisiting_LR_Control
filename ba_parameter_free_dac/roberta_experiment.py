...
def setup_trainer(model, tokenized_datasets, optimizer_cfg):
    ...
    optimizer = (get_optimizer_type(optimizer_cfg.type)(model.parameters(), **kwargs) if kwargs else
...
def main(cfg):
    ...
    tokenized_datasets = load_and_tokenize_dataset(save_path='../tokenized_dataset', subset_ratio=0.16, batch_size=512)
